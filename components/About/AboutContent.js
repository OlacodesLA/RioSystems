...
const AboutContent = () => {
  return (
    <div>
      <main class="mt-10">
        <div class="mb-4 md:mb-0 w-full h-[24em] max-w-screen-md mx-auto relative">
          <div
        ...
        <div class="px-4 lg:px-0 mt-12 text-gray-700 max-w-screen-md mx-auto text-lg leading-relaxed text-justify">
          <p class="pb-6 ">
